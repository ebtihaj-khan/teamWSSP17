...
public class AdminCustomAdapterComplaints extends RecyclerView.Adapter<AdminCustomAdapterComplaints.ViewHolder>
    ...
    String TAG = "MyApp";
    Context mContext;
    ArrayList<AdminComplaintsModel> complaintsList;
    ArrayList<AdminComplaintsModel> mOriginalValues; // Original Values



    public AdminCustomAdapterComplaints(Context c, ArrayList<AdminComplaintsModel> comps) {
        mContext = c;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        AdminComplaintsModel mc = complaintsList.get(position);
        holder.bindData(mc);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ArrayList<AdminComplaintsModel> myComplaintsList;
        ...
        public ViewHolder(Context c, View v, ArrayList<AdminComplaintsModel> compList) {
            super(v);
            mContext = c;
...
//            avi = (AVLoadingIndicatorView) v.findViewById(R.id.loadingIndicator);
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AdminComplaintsModel complaint = myComplaintsList.get(getAdapterPosition());
        ...
        public void bindData(AdminComplaintsModel mc) {
    ...
    public Filter getFilter() {
        ...
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                complaintsList = (ArrayList<AdminComplaintsModel>) results.values; // has the filtered values
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                ArrayList<AdminComplaintsModel> FilteredArrList = new ArrayList<>();

                if (mOriginalValues == null) {
                    mOriginalValues = new ArrayList<AdminComplaintsModel>(complaintsList); // saves the original data in mOriginalValues
                }
...
//                            FilteredArrList.add(new AdminComplaintsModel(mOriginalValues.get(i).getcType()
